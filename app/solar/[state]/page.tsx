...
// ─── Sample data (replace with JSON import or fetch) ─────────────────────────

const STATES_DATA: Record<string, StateData> = {
  arizona: {
    id: 1, name: 'Arizona', slug: 'arizona', abbreviation: 'AZ',
    avgSolarScore: 97, avgSunHours: 6.5, avgAnnualSavings: 943, avgPaybackYears: 6.5,
    cityCount: 47, climateType: 'Hot Desert', avgTemperature: 75,
    cloudyDaysPerYear: 85, rainyDaysPerYear: 36, installerCount: 127, rating: 5,
    stateIncentives: { propertyTaxExemption: 2000, energyTaxCredit: 3000, netMetering: 'Excellent' },
    topCities: ['Phoenix', 'Tucson', 'Mesa', 'Scottsdale', 'Tempe', 'Chandler', 'Gilbert', 'Glendale', 'Peoria', 'Surprise'],
    pros: [
      'Highest solar scores in the nation — avg 97/100',
      '300+ sunny days per year guaranteed',
      'Low humidity means panels stay efficient',
      'Strong state incentives up to $5,000',
      'Fast payback period (6.5 years vs 10 national avg)',
      'HOA-friendly solar laws enforced statewide',
    ],
    cons: [
      'Extreme heat above 95°F reduces panel efficiency ~10%',
      'Dust storms require more frequent panel cleaning',
      'High heat accelerates roof aging',
      'Some utility companies limit export credits',
    ],
    metaTitle: 'Arizona Solar Potential | 47 Cities Analyzed | SolarAtlas',
    metaDescription: 'Arizona has the best solar potential in the USA (score 97/100). Save $943/year avg. Free analysis for all 47 Arizona cities.',
  },
  texas: {
    id: 2, name: 'Texas', slug: 'texas', abbreviation: 'TX',
    avgSolarScore: 82, avgSunHours: 5.2, avgAnnualSavings: 712, avgPaybackYears: 16.8,
    cityCount: 127, climateType: 'Subtropical/Humid', avgTemperature: 68,
    cloudyDaysPerYear: 100, rainyDaysPerYear: 85, installerCount: 156, rating: 4,
    stateIncentives: { propertyTaxExemption: 1500, energyTaxCredit: 0, netMetering: 'Good' },
    topCities: ['Austin', 'San Antonio', 'Dallas', 'Houston', 'Fort Worth', 'El Paso', 'Arlington', 'Corpus Christi', 'Plano', 'Lubbock'],
    pros: [
      'Deregulated energy market = higher solar ROI',
      'Property tax exemption on added home value',
      'Strong installer competition keeps prices low',
      'ERCOT grid allows excess export credits',
    ],
    cons: [
      'No state income tax credit for solar',
      'Higher humidity reduces some panel efficiency',
      'Ice storms can damage systems temporarily',
      'Net metering policies vary by utility',
    ],
    metaTitle: 'Texas Solar Potential | 127 Cities Analyzed | SolarAtlas',
    metaDescription: 'Texas solar analysis: avg score 82/100. Save $712/year. Free calculator for all 127 Texas cities.',
  },
  nevada: {
    id: 3, name: 'Nevada', slug: 'nevada', abbreviation: 'NV',
    avgSolarScore: 96, avgSunHours: 6.3, avgAnnualSavings: 828, avgPaybackYears: 14.5,
    cityCount: 23, climateType: 'Hot Desert', avgTemperature: 72,
    cloudyDaysPerYear: 70, rainyDaysPerYear: 30, installerCount: 89, rating: 5,
    stateIncentives: { propertyTaxExemption: 1800, energyTaxCredit: 0, netMetering: 'Excellent' },
    topCities: ['Las Vegas', 'Henderson', 'Reno', 'North Las Vegas', 'Sparks', 'Carson City'],
    pros: [
      '2nd highest solar score in the US (96/100)',
      'Only 70 cloudy days per year',
      'Strong net metering policy pays full retail',
      'No state income tax means full federal credit value',
    ],
    cons: [
      'Small installer market (only 89 companies)',
      'Fewer state-level incentives than AZ or CA',
      'Desert heat causes some panel efficiency loss',
    ],
    metaTitle: 'Nevada Solar Potential | 23 Cities Analyzed | SolarAtlas',
    metaDescription: 'Nevada is 2nd best solar state (score 96). Save $828/year. Free solar analysis for all 23 Nevada cities.',
  },
}
...
const MONTHLY_DATA = {
  arizona: [
    { month: 'Jan', sunHours: 5.2, avgKwh: 624, savings: 81 },
    { month: 'Feb', sunHours: 6.1, avgKwh: 732, savings: 95 },
    { month: 'Mar', sunHours: 7.0, avgKwh: 840, savings: 109 },
    { month: 'Apr', sunHours: 7.2, avgKwh: 864, savings: 112 },
    { month: 'May', sunHours: 7.3, avgKwh: 876, savings: 114 },
    { month: 'Jun', sunHours: 7.5, avgKwh: 900, savings: 117 },
    { month: 'Jul', sunHours: 7.3, avgKwh: 876, savings: 114 },
    { month: 'Aug', sunHours: 7.0, avgKwh: 840, savings: 109 },
    { month: 'Sep', sunHours: 6.5, avgKwh: 780, savings: 101 },
    { month: 'Oct', sunHours: 6.0, avgKwh: 720, savings: 94 },
    { month: 'Nov', sunHours: 5.4, avgKwh: 648, savings: 84 },
    { month: 'Dec', sunHours: 4.8, avgKwh: 576, savings: 75 },
  ],
  default: [
    { month: 'Jan', sunHours: 3.5, avgKwh: 420, savings: 55 },
    { month: 'Feb', sunHours: 4.2, avgKwh: 504, savings: 66 },
    { month: 'Mar', sunHours: 5.1, avgKwh: 612, savings: 80 },
    { month: 'Apr', sunHours: 5.6, avgKwh: 672, savings: 87 },
    { month: 'May', sunHours: 6.0, avgKwh: 720, savings: 94 },
    { month: 'Jun', sunHours: 6.3, avgKwh: 756, savings: 98 },
    { month: 'Jul', sunHours: 6.2, avgKwh: 744, savings: 97 },
    { month: 'Aug', sunHours: 5.9, avgKwh: 708, savings: 92 },
    { month: 'Sep', sunHours: 5.2, avgKwh: 624, savings: 81 },
    { month: 'Oct', sunHours: 4.3, avgKwh: 516, savings: 67 },
    { month: 'Nov', sunHours: 3.2, avgKwh: 384, savings: 50 },
    { month: 'Dec', sunHours: 2.8, avgKwh: 336, savings: 44 },
  ],
}
...
export default function StatePage() {
  ...
  const stateSlug = (params?.state as string) || 'arizona'
  const state = STATES_DATA[stateSlug] || STATES_DATA['arizona']
  const monthlyData = MONTHLY_DATA[stateSlug as keyof typeof MONTHLY_DATA] || MONTHLY_DATA.default
  ...
  const incentivesData = [
    { name: 'System Cost', value: SYSTEM_COST, fill: '#ef4444' },
    { name: 'Federal 30%', value: -(SYSTEM_COST * FEDERAL_CREDIT), fill: '#10b981' },
    { name: 'State Credit', value: -(state.stateIncentives.energyTaxCredit), fill: '#34d399' },
    { name: 'Prop Tax', value: -(state.stateIncentives.propertyTaxExemption), fill: '#6ee7b7' },
  ]

  const faqItems = [
    {
      q: `Is solar worth it in ${state.name}?`,
      a: `Absolutely. ${state.name} ranks among the top solar states with a ${state.avgSolarScore}/100 score and ${state.avgSunHours} peak sun hours daily. Average homeowners save $${state.avgAnnualSavings}/year, with a payback period of ${state.avgPaybackYears} years.`,
    },
    {
    ...
    },
    {
      ...
      a: `There are ${state.installerCount} licensed solar installers active in ${state.name}. Major national operators include Sunrun, Tesla, SunPower, and Palmetto, alongside local firms with lower overhead costs.`,
    },
    {
    ...
    },
    {
      ...
      a: `Yes. Net metering in ${state.name} is rated "${state.stateIncentives.netMetering}". Excess solar power exported to the grid earns credits on your utility bill, improving overall ROI significantly.`,
    },
    {
      q: `What system size do most ${state.name} homeowners install?`,
      a: `Most ${state.name} homeowners install 4–8 kW systems. Given ${state.avgSunHours} peak sun hours, a 6 kW system produces about ${Math.round(state.avgSunHours * 6 * 365)} kWh/year — enough to cover 100% of an average home's consumption.`,
    },
  ]
    ...
    <div className="min-h-screen bg-slate-900 text-white">
          ...
          <div className="mt-6 bg-slate-700/50 border border-slate-600 rounded-xl p-5 flex items-center gap-4">
            ...
            <div>
              ...
              <span className="text-slate-300 text-sm ml-2">
                — {state.name} utilities credit you at full retail rate for excess power exported to the grid.
              </span>
            </div>
          </div>
        </div>
      ...
      <section id="cities" className="px-6 py-16 bg-slate-800">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-slate-400 mb-8 text-sm">Ranked by solar score. Click any city for a full analysis.</p>

          <div className="grid md:grid-cols-2 gap-4">
            {state.topCities.map((city, i) => {
              const score = Math.max(70, state.avgSolarScore - i * 1.5)
              const savings = Math.round(state.avgAnnualSavings - i * 15)
              return (
                <a
                  key={city}
                  href={`/solar/${state.slug}/${city.toLowerCase().replace(/\s+/g, '-')}`}
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="font-bold group-hover:text-emerald-400 transition">{city}</div>
                    <div className="text-sm text-slate-400">{state.name} · {state.abbreviation}</div>
                  </div>
                  <div className="text-right">
                    <div className="text-sm font-bold text-emerald-400">{Math.round(score)}/100</div>
          ...
          <button className="mt-6 w-full py-3 border border-slate-600 hover:border-emerald-400 rounded-xl text-sm transition font-medium">
            View all {state.cityCount} cities in {state.name} →
          </button>
        </div>
      </section>
